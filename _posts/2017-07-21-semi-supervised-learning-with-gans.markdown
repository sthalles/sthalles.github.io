...
In the [Improved Techniques for Training GANs](https://arxiv.org/abs/1606.03498) paper, OpenAI reports state-of-the-art results for semi-supervised classification learning on MNIST, CIFAR-10 and SVHN. This notebook only uses some of the techniques described in the paper, and it was taken from the Udacity Deep learning Fundamentals nanodegree program in which I am graduated from.
